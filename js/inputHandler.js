...
import { selectPlanet, togglePlanetPanel, toggleFleetPanel, toggleShipyardPanel, updateDisplay, updatePlanetPanel, updateFleetPanel, showBattleDialog, closePlanetPanel, closeFleetPanel, closeShipyardPanel, switchFleetTab, updateShipyardPanel, showNotification, showGameOver, showAllPanels, hideAllPanels } from './uiManager.js';
...
export function setupEventListeners() {
    ...
    document.getElementById('shipyardBtn').addEventListener('click', () => {
